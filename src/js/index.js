...
const imagemBotaoTrocaaDeTema = document.querySelector(".imagem-botao");
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        ...
        // passo 8 - trocar a imagem do botão de alterar tema pra solpasso 8 - trocar a imagem do botão de alterar tema pra sol
